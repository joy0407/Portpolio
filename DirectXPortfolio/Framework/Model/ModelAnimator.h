...
public:
	...
	void SetAttachBoneIndex(UINT index) { attachDesc.AttachBoneIndex = index; }
	void CalculateAttachBoneIndex();

	void ChangeTexture(int index);
	void MakeTexture(int index) { CreateTexture(index); }
