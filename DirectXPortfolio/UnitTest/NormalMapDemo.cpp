...
void NormalMapDemo::Initialize()
{
	...
	shader = new Shader(L"32_NormalMap.fx");
...
{
	static Color brickColor = Color(1, 0.3f, 0.3f, 20);
	ImGui::ColorEdit3("Brick", brickColor);
	ImGui::SliderFloat("Blrick Shininess", &brickColor.a, 0.1f, 100.0f);
	...
	//Color emissive = wall->Emissive();
	ImGui::ColorEdit3("Color", wall->Emissive());
	ImGui::SliderFloat("Intesity", &wall->Emissive().a, 0, 1);
...
//oid NormalMapDemo::AddPointLights()
//
//	PointLight light;
//	light =
//	{
...
//
//
//oid NormalMapDemo::AddSpotLights()
//
//	SpotLight light;
//	light =
//	{
...
//
//
//oid NormalMapDemo::AddCapsuleLights()
//
//	CapsuleLight light;
//	light =
//	{
