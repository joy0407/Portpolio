...
void LightingDemo::Initialize()
{
	...
	shader = new Shader(L"33_Lighting.fx");
...
void LightingDemo::AddPointLights()
{
	PointLight light;
	light =
	{
	...
	light =
	{
	   ...
	   Color(0.6f, 0.2f, 0.7f, 1.0f),
	   Color(0.6f, 0.3f, 0.7f, 1.0f),
	   Vector3(25, 10, -30), 10.0f, 0.3f
	};
	Context::Get()->AddPointLight(light);
}

void LightingDemo::AddSpotLights()
{
	SpotLight light;
	light =
	{
...
//oid LightingDemo::AddSpotLights()
//
//	SpotLight light;
//	light =
//	{
...
//
//
//oid LightingDemo::AddCapsuleLights()
//
//	CapsuleLight light;
//	light =
//	{
