...
void InstanceFrameworkDemo::Initialize()
{
...
void InstanceFrameworkDemo::Destroy()
{
	
}

void InstanceFrameworkDemo::Update()
{
	sky->Update();
...
void InstanceFrameworkDemo::Render()
{
	//sky->Pass(11);
	sky->Render();
...
void InstanceFrameworkDemo::Mesh()
{
	//Create Material
	{
...
void InstanceFrameworkDemo::Airplane()
{
...
void InstanceFrameworkDemo::Kachujin()
{
	weapon = new Model();
...
//oid InstanceFrameworkDemo::AddPointLights()
//
//	PointLight light;
//	light =
//	{
...
//
//
//oid InstanceFrameworkDemo::AddSpotLights()
//
//	SpotLight light;
//	light =
//	{
...
//
//
//oid InstanceFrameworkDemo::AddCapsuleLights()
//
//	CapsuleLight light;
//	light =
//	{
...
void InstanceFrameworkDemo::Pass(UINT mesh, UINT model, UINT anim)
{
